...
4. Supply the existing GitHub repository URL. The parent home-folder repository has no remote; a separate project-local repository was initialized to avoid including personal files.
